  ...
  return (
    <div className="app-layout">
      ...
      <main className={
        ...
        {/* Floating Đổi Game Button — hiển thị khi đang chơi game */}
        <AnimatePresence>
          {(stage === 'm1_game' || stage === 'm2_game') && selectedGameId !== null && (
            <motion.div
              key="doi-game-fab"
            ...
            >
              <button
                ...
                title="Chọn game khác (giữ nguyên bộ câu hỏi)"
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: 8,
                  ...
                  boxShadow: '0 4px 24px rgba(99,102,241,0.45), 0 1.5px 6px rgba(0,0,0,0.18)',
                  cursor: 'pointer',
                  letterSpacing: 0.2,
                ...
                onMouseEnter={e => {
                  ...
                  (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 8px 32px rgba(99,102,241,0.55), 0 2px 8px rgba(0,0,0,0.22)';
                }}
                onMouseLeave={e => {
                  (e.currentTarget as HTMLButtonElement).style.transform = 'scale(1)';
                  (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 4px 24px rgba(99,102,241,0.45), 0 1.5px 6px rgba(0,0,0,0.18)';
                }}
              >
                <Gamepad2 size={17} />
                🔄 Đổi Game
